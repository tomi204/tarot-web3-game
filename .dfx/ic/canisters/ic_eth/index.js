...
export const canisterId = process.env.CANISTER_ID_IC_ETH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_eth.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_eth canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_eth.did.js")._SERVICE>}
 */
export const ic_eth = createActor(canisterId);
